...
<body class="theme-bg">
  ...
  <div class='ltr ltr1'>H</div>
  <div class='ltr ltr2'>E</div>
  <div class='ltr ltr3'>L</div>
  <div class='ltr ltr4'>L</div>
  <div class='ltr ltr5'>O</div>
</div>
<br>
                            <!-- <h2 class="wow fadeInUp" data-wow-delay="0.4s" >I am Will Smith</h2> -->
                            <div class="typewriter">
  <h1 class="aa">I am Will Smith</h1>
</div>
...
<div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="../dashbord/uploads/works/<?=$work['work_image']?>" alt="img">
                            </div>
