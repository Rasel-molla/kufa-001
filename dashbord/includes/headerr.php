            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li class="<?= ($page_name == 'social_link.php') ? 'active-page' : '' ?>">
                        <a href="dashbord/../social_link.php" class="active"><i class="material-icons-two-tone">link</i>social links</a>
                    </li>
                    ...
                    <li class="<?= ($page_name == 'service_add.php') || ($page_name == 'service_list.php') ? 'active-page' : '' ?>">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a class="<?= ($page_name == 'service_add.php') ? 'active-page' : '' ?>" href="dashbord/../service_add.php">add service</a>
                            </li>
                            <li>
                                <a class="<?= ($page_name == 'service_list.php') ? 'active-page' : '' ?>" href="dashbord/../service_list.php">service list</a>
                            </li>
                    ...
                    <li class="<?= ($page_name == 'work_add.php') || ($page_name == 'work_list.php') ? 'active-page' : '' ?>">
                        ...
                        <ul class="sub-menu">
                            <li>
                                <a class="<?= ($page_name == 'work_add.php') ? 'active-page' : '' ?>" href="dashbord/../work_add.php">work add</a>
                            </li>
                            <li>
                                <a class="<?= ($page_name == 'work_list.php') ? 'active-page' : '' ?>" href="dashbord/../work_list.php">work list</a>
                            </li>
                        ...
                        <div class="d-flex">
                            <ul class="navbar-nav">
                                <li class="nav-item hidden-on-mobile  ">
                                    <a class="nav-link active btn btn-info text-white rounded-pill border border-info " tabindex="_blank " href="dashbord/../../fontend/index.php ">visit site</a>

                                </li>
                                <li class="nav-item hidden-on-mobile  ">
                                    <a class="nav-link active btn btn-danger text-white rounded-pill border border-info " href="dashbord/../auth/logout.php">logout</a>
