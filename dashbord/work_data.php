...
if (isset($_POST['add_work'])) {
  if ($work_image['name']) {
    ...
    if ($extension === 'png' || $extension === 'jpg') {
      ...
      $tem_name = $work_image['tmp_name'];
      $filepath = "./uploads/works/" . $new_image_name;
      move_uploaded_file($tem_name, $filepath);

      $work_query = "INSERT INTO `works`( `work_title`, 
`work_heading`, `work_description`, `work_status`, `work_image`) 
VALUES ('$work_title','$work_heading ','$work_description','$work_status','$new_image_name')
";
...
//update 
      $work_update_query = "UPDATE works  SET work_title= '$work_title',
work_heading= '$work_heading',
work_description= '$work_description' ,
work_status= '$work_status' ,
work_image= '$new_image_name' WHERE id='$update_id'";
