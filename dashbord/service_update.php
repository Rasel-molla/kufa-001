...
?>
    ...
    <div class="card-body">
      ...
      <div class="example-container">
           ...
           <input hidden type="number" name="service_title" value="<?=$service['id'] ?>">
               <input type="text" class="form-control
                form-control-rounded m-b-sm" 
        placeholder="service title" name="service_title" value="<?=$service['service_title'] ?>">
           </div>
           ...
           <label for="">service icon </label>
               <input readonly type="text" class="form-control
                form-control-rounded m-b-sm" 
        placeholder="icon" name="service_icon" id="icon_value" value="<?=$service['service_icon'] ?>">
       ...
       endforeach;
           ...
           <label for=""> service_description</label>
               <textarea cols="30" rows="5" class="form-control
                form-control-rounded m-b-sm" name="service_description" ><?=$service['service_description'] ?></textarea>
           ...
           <label for=""> service_status </label>
             <select name="service_status"  class="form-control
                form-control-rounded m-b-sm">
                <option value="active" <?=($service['service_status'] ===
                 'active' )? 'selected': '' ?>>active</option>
                <option value="inactive" <?=($service['service_status'] ===
