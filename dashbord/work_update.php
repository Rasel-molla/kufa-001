...
?>
    ...
    <div class="card-body">
      ...
      <div class="example-container">
        ...
        placeholder="service title" name="work_title" value="<?= $work['work_title']?>">
           </div>
           <div class="example-content">
           <label for="">work_heading </label>
               <input type="text" class="form-control
                form-control-rounded m-b-sm" 
        placeholder="service title" name="work_heading" value="<?= $work['work_heading']?>">
           </div>
           ...
           <label for=""> work_description</label>
               <textarea cols="30" rows="5" class="form-control
                form-control-rounded m-b-sm" name="work_description" value="<?= $work['work_description']?>"></textarea>
        ...
        placeholder="service title" name="work_image">
           ...
           <label for=""> work_status </label>
             <select name="work_status"  class="form-control
                form-control-rounded m-b-sm">
                <option value="active" <?=($work['work_status'] ===
                 'active' )? 'selected': '' ?>>active</option>
                <option value="inactive" <?=($work['work_status'] ===
