...
$users_users_count = mysqli_fetch_assoc($total_users_db);
                ...
                <div class="card-body">
                    <div class="widget-stats-container d-flex">
                        ...
                        <div class="widget-stats-content flex-fill">
                            ...
                            <span class="widget-stats-amount"> <?= $users_users_count['total'] ?> </span>
        ...
        <div class="col-xl-6">
            <div class="card widget widget-list" style="height:460px ; overflow-Y:scroll;">
                <div class="card-header">
                    <h5 class="card-title">Active User<span class="badge badge-success badge-style-light">
                            <?= $users_users_count['total'] ?> Users || </span></h5>


                </div>
                <div class="card-body">
                    <span class="text-muted m-b-xs d-block">showing 
                        <?=$users_query_db->num_rows?> out of  <?= $users_users_count['total'] ?> active tasks.</span>
